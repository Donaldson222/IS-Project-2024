...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Gari Poa - User Homepage</title>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="location-form">
                            ...
                            <form action="insertion.inc.php" method="POST">
                                ...
                                <div class="control-group">
                                <input type="tel" name="phone" class="form-control" placeholder="Phone Number" value="<?php echo $row1['Phone_Number']; ?>" required="required" pattern="[0-9]{10}" />
                            </div>
                                                                <div class="control-group">
